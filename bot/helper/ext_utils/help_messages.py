...
def get_bot_commands():
    ...
    static_commands = {
        ...
        "Login": "[password] Login to the bot when password access is enabled",
        "Mirror": "[link/file] Mirror to Upload Destination",
        "QbMirror": "[magnet/torrent] Mirror to Upload Destination using qbit",
        "JdMirror": "[link/file] Mirror using JDownloader",
        "NzbMirror": "[nzb] Mirror using Sabnzbd",
        ...
        "JdLeech": "[link/file] Leech to Telegram using JDownloader",
        "NzbLeech": "[nzb] Leech to Telegram using Sabnzbd",
        ...
        "Delete": "[link] Delete a file or folder from Google Drive",
        ...
        "Users": "[SUDO] View authorized and sudo users",
        "CancelTask": "[gid/reply] Cancel a running task",
        ...
        "Broadcast": "[SUDO] Broadcast a message to bot users",
        ...
        "AddSudo": "[SUDO] Grant sudo access",
        "RmSudo": "[SUDO] Remove sudo access",
        "BlackList": "[SUDO] Blacklist a user",
        "RmBlackList": "[SUDO] Remove a user from the blacklist",
        "NzbSearch": "[query] Search configured Usenet indexers",
        ...
        "Setup": "[OWNER] Open the interactive setup wizard",
    }
