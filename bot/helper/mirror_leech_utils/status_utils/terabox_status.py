...
class TeraboxDownloadStatus:
    ...
    def progress_raw(self):
        return round(self._obj.downloaded_bytes / self.listener.size * 100, 2) if self.listener.size else 0
    ...
    def eta(self):
        ...
        return get_readable_time(
            (self.listener.size - self._obj.downloaded_bytes) / self._obj.speed
        )
