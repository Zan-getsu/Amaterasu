...
DEFAULT_DESP = {
    ...
    "DEFAULT_UPLOAD": "Default upload destination: gd (Google Drive), rc (rclone), or tbx (TeraBox).",
    ...
    "TERABOX_ENABLED": "Enable native TeraBox downloads and uploads.",
    "TERABOX_LIMIT": "TeraBox download size limit in GB. 0 = unlimited.",
    "TERABOX_UPLOAD_PATH": "Default TeraBox destination folder for -up tbx.",
